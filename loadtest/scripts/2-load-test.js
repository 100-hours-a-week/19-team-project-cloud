...
export const options = {
  ...
  thresholds: {
    // 일반 API
    'expert_search_duration': ['p(95)<2000'],
    'resume_list_duration': ['p(95)<1000'],
...
export function handleSummary(data) {
  ...
  console.log(`   현직자 검색 P95: ${expertP95?.toFixed(0)}ms ${expertP95 < 2000 ? '✅' : '❌'} (목표: 2000ms)`);
  console.log(`   LLM 파싱 P95: ${llmP95?.toFixed(0)}ms ${llmP95 < 7000 ? '✅' : '❌'} (목표: 7000ms)`);
  console.log(`   에러율: ${errorRate?.toFixed(2)}% ${errorRate < 2 ? '✅' : '❌'} (목표: <2%)`);
  console.log('');
